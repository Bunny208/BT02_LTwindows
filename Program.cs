...
namespace ConsoleApp1
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            students.Add(new Student (1, "Anh" , 18));
            students.Add(new Student(2, "Bao", 13));
            students.Add(new Student(2, "Chi", 11));
            students.Add(new Student(2, "Dung", 16));
            students.Add(new Student(2, "An", 17));
            ...
            Console.WriteLine("Danh sach hs co ten bat dau bang A :");
